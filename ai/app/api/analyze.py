    ...
    for primary in router_results:
        ...
        if primary.route_type == "CLARIFICATION":
            ...
            if recent_ai_msgs and "?" in recent_ai_msgs[-1].get("content", ""):
                ...
                hk_kws = ["수건", "타월", "어메니티", "베개", "이불", "청소", "생수", "물", "비누", "칫솔", "샴푸", "휴지", "화장지", "towel", "amenity", "water", "blanket", "cleaning", "가운", "샤워가운", "슬리퍼"]
                facility_kws = ["에어컨", "히터", "난방", "보일러", "수압", "변기", "와이파이", "조명", "tv", "리모컨", "콘센트", "키카드", "잠김", "충전기", "고장", "aircon", "heating", "wifi", "toilet", "light", "charger"]
                fb_kws = ["룸서비스", "메뉴", "식음료", "음료", "와인잔", "오프너", "얼음", "디쉬", "식사", "밥", "room service", "wine", "ice", "opener", "coke", "콜라", "사이다", "주스"]
                concierge_kws = ["맛집", "식당", "예약", "파스타", "삼겹살", "돈까스", "국수", "관광", "투어", "경복궁", "ddp", "남산", "택시", "꽃배달", "꽃", "꽃다발", "장미", "장미꽃", "짐", "캐리어", "보관", "짐보관", "공항버스", "6001", "버스", "약국", "응급실", "병원", "모닝콜", "recommend", "restaurant", "taxi", "flower", "booking"]
