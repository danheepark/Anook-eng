...
async def run_emergency_agent(user_message: str, room_no: str, chat_history: list = None, images: list = None, system_language: str = "en", active_requests: list = None, **kwargs) -> dict:
    if chat_history:
        context = "\n".join([
